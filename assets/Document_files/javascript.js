...
submitEl.addEventListener("click", function(event){
    ...
    localStorage.setItem("Initial", JSON.stringify(userInfo))
    
    //Hides the form
    inputEl.classList.add("hide")
    
    //Gets initials from local storage and displays it on the main container
...
//question:???????????/ why localstorage only listen to button click not submit input?